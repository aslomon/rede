...
enum RedeCleanupService {
    ...
    static func knownInstallBundleURLs() -> [URL] {
        RedeInstallLocationService.knownInstallBundleURLs
    }
    ...
    static func cleanup(paths: [URL], unregisterLaunchAtLogin: Bool) -> CleanupReport {
        ...
        if unregisterLaunchAtLogin {
            do {
                ...
                failedItems.append(
                    CleanupItemFailure(
                        url: RedeInstallLocationService.bundleURL,
        ...
        return CleanupReport(
            ...
            knownInstallBundleURLs: RedeInstallLocationService.otherInstalledBundleURLs
        )
    }
