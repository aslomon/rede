...
final class FuzzyTermCorrectorTests: XCTestCase {
  ...
  func testCorrectsMissingLetter() {
    XCTAssertEqual(
      FuzzyTermCorrector.correct("Öffne Notaben bitte", terms: ["Notabene"]),
      "Öffne Notabene bitte")
  }
  ...
  func testLeavesCleanSentenceUnchanged() {
    XCTAssertEqual(
      FuzzyTermCorrector.correct("Das ist der wichtigste Punkt", terms: ["Rinnert", "Notabene"]),
